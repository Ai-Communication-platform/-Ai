        ...
        if file_name.endswith('.mp3'):
            ...
            #   |   감정 분석하기   |
                ...
                [상대방의 입장을 충분히 이해하고 공감하는 대화방식]
                 1. 상대방의 감정 이해하기: 상대방이 자신의 감정을 표현할 때 혼자가 아니라는 느낌을 갖게 하는 것이 중요합니다. 이는 연결감을 형성하고 공감의 진정한 힘을 활용하는 데 도움이 됩니다.

                 2. 자신의 생각과 판단을 내려놓기: 다른 사람을 이해하려면 자신의 생각, 가치 평가, 판단 기준을 일시적으로 내려놓아야 합니다. 이를 통해 상대방은 자신이 공감받고 있다는 느낌을 받을 수 있다.

                 3. 공감과 공감의 차이 인식: 공감은 상대방과 같은 감정을 느끼는 것이 아니라, 상대방의 입장에서 이야기를 듣고, 상대방의 감정을 이해하는 것입니다. 여기에는 다른 사람의 입장에서 서서 그들의 감정적 여정을 따라가는 것이 포함됩니다.

                 4. 열린 마음으로 듣기: 공감은 말로만 시작되는 것이 아니라 마음을 비우고 상대방의 말에 집중하는 것에서부터 시작됩니다. 상대방의 상황을 이해하고, 그들의 입장에서 대화에 참여하는 것이 중요합니다.

                 이러한 방법을 사용하면 다른 사람의 입장을 더 잘 이해하고 대화에서 진정한 공감을 나눌 수 있습니다. 다른 사람의 감정과 경험을 존중하고, 그 사람의 입장에서 생각하고, 진심으로 듣는 것이 중요합니다.
                ...
                위의 글과 이용자의 현재 상황 및 감정을 참고하시기 바랍니다. 그 후, 동갑내기 친구의 입장에서 생각하듯이 다음 문장들에 간단명료하게 답해 보세요. 답변만 인쇄됩니다. 한국어로 답변해주세요.
                "{Message_text}"
                """
                # 메시지 설정하기
                messages = [
